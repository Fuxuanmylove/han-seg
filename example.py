...
def test():
    # 初始化thulac引擎
    seg1 = HanSeg('jieba', filt=True, multi_engines=True, config_path=CONFIG_PATH)
    seg2 = HanSeg('thulac', filt=True, multi_engines=True, config_path=CONFIG_PATH)
    seg3 = HanSeg('pkuseg', filt=True, multi_engines=True, config_path=CONFIG_PATH)
    seg4 = HanSeg('snownlp', filt=True, multi_engines=True, config_path=CONFIG_PATH)
